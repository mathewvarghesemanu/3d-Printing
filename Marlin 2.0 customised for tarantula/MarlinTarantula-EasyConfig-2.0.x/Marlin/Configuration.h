...
/**
 * Offset from endpoins to get nozzle to 0,0 (front/left of bed)
 ...
 */
#define E0_STEPS      94.75 // Stock extruder. If you have a Tevo Titan, try 400 then calibrate.
 ...
 */
#define Z_STEPS      1615.78 // Stock lead screw
...
#define STRING_CONFIG_H_AUTHOR "(Mathew Varghese, EasyConfig 1-8-2020)" // Who made the changes.
 ...
 */
#if ENABLED(DUAL_EXTRUDER)
  #define DEFAULT_AXIS_STEPS_PER_UNIT   { 80.22, 80.22, Z_STEPS, E0_STEPS, E1_STEPS }
#else
  #define DEFAULT_AXIS_STEPS_PER_UNIT   { 80.22, 80.22, Z_STEPS, E0_STEPS }
#endif
